    ...
    const chatStore = useChatStore(),
        ...
        methods = {
            context: (text, id, event) => {
                ...
                data.cursorY = event.y > 608 ? 608 : event.y;
                console.log("data.cursorY", data.cursorY);
                console.log("data.cursorX", data.cursorX);
            },
            sendMessage: async () => {
    ...
    <div class="c-chat-field">
        <div class="content">
            ...
            >
                ...
                >
                    <template #content>
                        <span class="option" @click="methods.editMode"
                            >Редактировать</span
                        >
                ...
                >
                    <ChatMessage
                        ...
                        @contextmenu="
                            (event) => methods.context(item.text, index, event)
                        "
                        :key="index"
                        :text="item.text"
